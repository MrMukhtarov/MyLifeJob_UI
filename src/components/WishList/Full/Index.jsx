...
const Index = () => {
  return (
    <section className='wish_full' style={{minHeight:"100vh"}}>
    <div className="wish_full_heading">
          ...
          <tr>
            <th scope="row">
              <div className="d-flex align-items-center">
                ...
                <NavLink className="wish_full_name" to="/">
                  <p className="mb-0">Administrative Assistant (female)</p>
                </NavLink>
                <span className="wish_full_premium">PREMIUM</span>
              </div>
            </th>
            <td>
              <div className="wish_full_company d-flex align-items-center gap-1">
                <img
